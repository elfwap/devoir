...
/**
 * Missing View Layout Exception, thrown when the specified view class is not found.
 * @namespace Devoir\Exception
 ...
 *        
 */
class MissingViewLayoutException extends DevoirException
{
	/**
	 *
	 * @param mixed $message
	...
	{
		$this->template = "View Layout `%s` not found.";
		$this->code = MISSING_VIEW_LAYOUT_EXCEPTION_CODE;
